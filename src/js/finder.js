...
export class FinderView extends Finder {
  ...
  update() {
    ...
    userPage.querySelector("img").src = `https://github.com/${this.user.login}.png`;
    ...
    userPage.querySelector("#account-numbers #repos").textContent = this.user.public_repos;
    userPage.querySelector("#account-numbers #followers").textContent = this.user.followers;
    userPage.querySelector("#account-numbers #following").textContent = this.user.following;
    userPage.querySelector("#user-info #location").textContent = this.user.location;

    if (this.user.twitter_username !== null) {
      userPage.querySelector("#user-info #twitter").textContent = this.user.twitter_username;
      userPage.querySelector("#user-info #twitter").href = `https://twitter.com/${this.user.twitter_username}`
      toggleClassNotAvailable("twitter")
    } else {
      userPage.querySelector("#user-info #twitter").textContent = 'Not Available'
      toggleClassNotAvailable("twitter");
    }
    ...
    if (this.user.location !== null) {
      ...
      userPage.querySelector("#user-info #location").textContent = 'Not Available';
      toggleClassNotAvailable("location")
    }

    if (this.user.company !== null) {
      userPage.querySelector("#user-info #company").textContent = this.user.company;
      toggleClassNotAvailable("company");
    } else {
      userPage.querySelector("#user-info #company").textContent = 'Not Available'
      toggleClassNotAvailable("company");
    }
